...
//  customPushFullScreenNotBackNavigator(context ,Widget page) async {
//   if (kIsWeb) {
...
//
// //  push to new screen and hide bottom bar
//  customPushFullScreenNavigator(context ,Widget page) async {
//   if (kIsWeb) {
//     Navigator.of(context, rootNavigator: true).push(
//       PageRouteBuilder(
//         transitionDuration: const Duration(milliseconds: 250),
...
//   customPushReplacement(context ,Widget page,)async {
//
//   if (kIsWeb) {
...
//   customPushReplacementFullScreen(context ,Widget page)async {
//   if (kIsWeb) {
